...
class TestBankTransaction(FrappeTestCase):
	...
	# This test checks if SilkOS is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if SilkOS can correctly filter a linked payments based on the debit/credit amount
